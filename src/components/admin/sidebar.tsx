...
export default function Sidebar() {
  ...
  return (
    <>
      {/* HEADER */}
      <header className="fixed top-0 left-0 w-full z-50 border-b border-zinc-800 bg-zinc-950 px-4 py-3 flex items-center justify-between">
        <button
